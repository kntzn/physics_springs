...
Как прекрасно видно, даже три тела и три пружины требуют столько переменных, что в них <s>черт ногу сломит</s> уже легко запутаться. Важно понимать, что при увеличении количества тел, количество переменных будет неуклонно расти. Потому, сделаем обобщение для N тел, используя массивы и циклы.
